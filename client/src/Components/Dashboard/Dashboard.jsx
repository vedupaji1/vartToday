...
const Dashboard = () => {
    ...
    const copyImageUrl = async (i) => {
        let imageURL = document.getElementsByClassName("dataImage")[i].src;
        if (imageURL !== "") {
                                ...
                                topData[i][0] !== "" ?
                                    <div key={i} className="dataShowerComponent">
                                        ...
                                        <div className="mainImageData">
                                            <CircularLoader />
                                            <img onLoad={() => {
                                                document.getElementsByClassName("mainCircularLoaderDiv")[i].style.display = "none"
                                            }} src={topData[i][1]} alt="img" className="dataImage" />
                                        </div>
                                        <div className="aboutDataImage">
                                            <div className="publishedDate">{getProperDate(topData[i][3]._hex * 1000)}</div>
                                            <div className="mainAboutData"><pre>{topData[i][2]}</pre></div>
